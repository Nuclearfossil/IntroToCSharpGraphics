...
namespace ShaderIntroduction
{
    ...
    {
        public QuaternionCamera(GameWindow window) : base(window)
        {
        }
        ...
        //{ }
        public QuaternionCamera(GameWindow gameWindow, MouseDevice moused, KeyboardDevice keyd, INativeWindow game, Vector3 position = new Vector3(), Quaternion orientation = new Quaternion(), bool mouseLook = true) : base(gameWindow)
        {
            Speed = 0.2f;
